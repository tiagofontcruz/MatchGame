...
import javax.sound.sampled.AudioInputStream;                                                                    //An audio input stream is an input stream with a specified audio format and length.
import javax.sound.sampled.AudioSystem;                                                                         //The AudioSystem class includes many methods that manipulate AudioInputStream objects.
